...
class PiercingPatternIndicatorTest :
    FunSpec({
        test("Positive Test for Piercing Pattern Bullish Indicator") {
            val data =
                listOf(
                    OHLC(1, 10.0, 12.0, 8.0, 9.0),
                    OHLC(1, 9.0, 10.0, 4.0, 5.0),
                    OHLC(1, 3.0, 2.0, 8.0, 7.0),
                )
        ...
        test("Positive Test for Piercing Pattern Bearish Indicator") {
            val data =
                listOf(
                    OHLC(1, 5.0, 12.0, 4.0, 8.0),
                    OHLC(1, 5.0, 12.0, 6.0, 10.0),
                    OHLC(1, 12.0, 14.0, 6.0, 7.0),
                )
