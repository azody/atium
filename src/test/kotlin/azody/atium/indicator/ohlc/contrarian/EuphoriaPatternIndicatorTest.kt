...
class EuphoriaPatternIndicatorTest :
    FunSpec({
        test("Positive Test for Euphoria Bullish Indicator") {
            val data =
                listOf(
                    OHLC(1, 10.0, 10.0, 2.0, 8.0),
                    OHLC(1, 9.0, 10.0, 2.0, 6.0),
                    OHLC(1, 8.0, 10.0, 2.0, 4.0),
                )
        ...
        test("Positive Test for Euphoria Bearish Indicator") {
            val data =
                listOf(
                    OHLC(1, 5.0, 10.0, 2.0, 6.0),
                    OHLC(1, 6.0, 10.0, 2.0, 8.0),
                    OHLC(1, 7.0, 10.0, 2.0, 10.0),
                )
