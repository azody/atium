...
class ShrinkingPatternIndicatorTest :
    FunSpec({
        test("Positive Test for Shrinking Pattern Bullish Indicator") {
            val data =
                listOf(
                    OHLC(20.0, 22.0, 13.0, 15.0),
                    OHLC(15.0, 15.0, 5.0, 11.0),
                    OHLC(14.0, 15.0, 5.0, 11.0),
                    OHLC(13.0, 15.0, 5.0, 11.0),
                    OHLC(10.0, 17.0, 8.0, 17.0),
                )
        ...
        test("Positive Test for Shrinking Pattern Bearish Indicator") {
            val data =
                listOf(
                    OHLC(15.0, 30.0, 13.0, 25.0),
                    OHLC(25.0, 30.0, 24.0, 30.0),
                    OHLC(26.0, 30.0, 24.0, 30.0),
                    OHLC(27.0, 30.0, 24.0, 30.0),
                    OHLC(28.0, 30.0, 15.0, 17.0),
                )
