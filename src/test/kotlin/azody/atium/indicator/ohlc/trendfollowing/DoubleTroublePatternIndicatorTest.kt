...
class DoubleTroublePatternIndicatorTest :
    FunSpec({
        test("Positive Test for Double Trouble Bullish Indicator") {
            val data =
                listOf(
                    OHLC(1, 10.0, 14.0, 9.0, 13.0, 10.0, mapOf(VolatilityIndicator.AVERAGE_TRUE_RANGE to 1.0)),
                    OHLC(1, 11.0, 18.0, 10.0, 16.0, 10.0, mapOf(VolatilityIndicator.AVERAGE_TRUE_RANGE to 1.0)),
                )
        ...
        test("Negative Test for Double Trouble Bullish Indicator") {
            val data =
                listOf(
                    OHLC(1, 10.0, 14.0, 9.0, 13.0, 10.0, mapOf(VolatilityIndicator.AVERAGE_TRUE_RANGE to 10.0)),
                    OHLC(1, 11.0, 18.0, 10.0, 16.0, 10.0, mapOf(VolatilityIndicator.AVERAGE_TRUE_RANGE to 10.0)),
                )
        ...
        test("Positive Test for Double Trouble Bearish Indicator") {
            val data =
                listOf(
                    OHLC(1, 10.0, 11.0, 7.0, 8.0, 10.0, mapOf(VolatilityIndicator.AVERAGE_TRUE_RANGE to 1.0)),
                    OHLC(1, 9.0, 10.0, 4.0, 5.0, 10.0, mapOf(VolatilityIndicator.AVERAGE_TRUE_RANGE to 1.0)),
                )
        ...
        test("Negative Test for Double Trouble Bearish Indicator") {
            val data =
                listOf(
                    OHLC(1, 10.0, 11.0, 7.0, 8.0, 10.0, mapOf(VolatilityIndicator.AVERAGE_TRUE_RANGE to 10.0)),
                    OHLC(1, 9.0, 10.0, 4.0, 5.0, 10.0, mapOf(VolatilityIndicator.AVERAGE_TRUE_RANGE to 10.0)),
                )
