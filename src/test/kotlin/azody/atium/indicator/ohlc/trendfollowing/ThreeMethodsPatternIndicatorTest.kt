        ...
        test("Positive Test for Three Methods Pattern Bullish Indicator") {
            val data =
                listOf(
                    ...
                    OHLC(1, 8.0, 9.0, 7.0, 7.0),
                    OHLC(1, 7.0, 8.0, 6.0, 6.0),
                    OHLC(1, 6.0, 7.0, 5.0, 5.0),
                    OHLC(1, 7.0, 6.0, 6.0, 15.0),
                )
        ...
        test("Positive Test for Three Methods Pattern Bearish Indicator") {
            val data =
                listOf(
                    ...
                    OHLC(1, 7.0, 9.0, 7.0, 8.0),
                    OHLC(1, 6.0, 8.0, 6.0, 7.0),
                    OHLC(1, 5.0, 7.0, 5.0, 6.0),
                    OHLC(1, 7.0, 7.0, 1.0, 1.0),
                )
