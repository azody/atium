...
class TasukiPatternIndicatorTest :
    FunSpec({
        test("Positive Test for Tasuki Pattern Bullish Indicator") {
            val data =
                listOf(
                    OHLC(1, 8.0, 11.0, 6.0, 10.0),
                    OHLC(1, 12.0, 15.0, 13.0, 14.0),
                    OHLC(1, 13.0, 16.0, 11.0, 11.5),
                )
        ...
        test("Positive Test for Tasuki Pattern Bearish Indicator") {
            val data =
                listOf(
                    OHLC(1, 14.0, 15.0, 9.0, 10.0),
                    OHLC(1, 8.0, 9.0, 5.0, 6.0),
                    OHLC(1, 6.0, 9.5, 5.0, 8.5),
                )
