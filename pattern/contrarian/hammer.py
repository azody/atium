...
"""
def hammer_bullish_indicator(data, i: int, open_column: int, high_column: int, low_column: int, close_column: int, body, wick) -> bool:
    """
    Bullish Criteria
...
def hammer_bearish_indicator(data, i: int, open_column: int, high_column: int, low_column: int, close_column: int, body, wick) -> bool:
    """
    Bearish Criteria
...
def signal(data, open_column, high_column, low_column, close_column, buy_column, sell_column, body, wick):
    ...
    for i in range(len(data)):
       ...
       try:
            # Bullish pattern
            if hammer_bullish_indicator(data, i, open_column, high_column, low_column, close_column, body, wick):
                data[i + 1, buy_column] = 1

            # Bearish pattern
            elif  hammer_bearish_indicator(data, i, open_column, high_column, low_column, close_column, body, wick):
