# -*- coding: utf-8 -*-
"""
Created on Tue Nov  7 11:07:23 2023
...
- Bullish Pattern
    ...
    - And the second candles close price is lower than the open price of the first candle
    - And the second candles open price is higher than the close price of the previous candle
- Bearish Pattern
    - The first candle is bulklish
    - And the second candle is bearish
    - And the second candles has a lower open price than the close price of the first candle
    - And the second candles close price is higher than the open price of the first candle
